...
class Station(Producer):
    ...
    def __init__(self, station_id, name, color, direction_a=None, direction_b=None):
        ...
        topic_name = f"org.chicago.transit.looptrain.{station_name}.arrivals"
        super().__init__(
            topic_name,
    ...
    def run(self, train, direction, prev_station_id, prev_direction):
        ...
        logger.info(f"Sending arrival message to kafka topic {self.topic_name}") 
        arrival_message = {
